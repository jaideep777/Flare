...
// g++ -O3 -Wall -Wl,--no-as-needed -std=c++11 -I/usr/local/netcdf-c-4.3.2/include -I/usr/local/netcdf-cxx-legacy/include -I/home/jaideep/Documents/libgsm_v2/include -L/home/jaideep/Documents/libgsm_v2/lib -L/usr/local/netcdf-cxx-legacy/lib -o 1 reverse_array_test.cpp -pthread -l:libgsm.so.2 -lnetcdf_c++ 
