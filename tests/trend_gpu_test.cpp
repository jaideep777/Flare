...
// g++ -I/usr/local/netcdf-c/include -I/usr/local/netcdf-cxx-legacy/include -I/home/chethana/codes/Flare/include -L/home/chethana/codes/Flare/lib -L/usr/local/netcdf-cxx-legacy/lib -o 1 trend_gpu_test.cpp -l:libflare.so.3 -lnetcdf_c++ 
...
//	for (int i=0; i<times.size(); ++i) times[i]= ymd2gday("2001-1-1")+ i*365.2524/24 + 6 - ymd2gday("2000-1-1");
	...
	string files[] = 
	{
		"/media/chethana/Totoro/Data/GPP_modis/gpp.2000-2015.nc",
	};
