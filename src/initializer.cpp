...
Initializer::Initializer(string fname){
	init_fname = fname;
}

void Initializer::setInitFile(string fname){
	init_fname = fname;
}
...
string Initializer::getString(string s){
...
float Initializer::getScalar(string s){
...
vector <float> Initializer::getArray(string s, int size = -1){
