...
Colour_rgb::Colour_rgb(float rr, float gg, float bb){
	r=rr; b=bb; g=gg;
}
...
//vector <Colour_rgb> createPalette_rainbow(int N){
...
vector <Colour_rgb> createPalette_rainbow(int N, float start=0, float end=1){
	vector <Colour_rgb> p(N);
	for (int i=0; i<N; ++i){
...
vector <Colour_rgb> createPalette_random(int N, float start=0, float end=1){
	vector <Colour_rgb> p(N);
	for (int i=0; i<N; ++i){
...
vector <Colour_rgb> createPalette_grayscale(int N, float start=0, float end=1){
	vector <Colour_rgb> p(N);
	for (int i=0; i<N; ++i){
